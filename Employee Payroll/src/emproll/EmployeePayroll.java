...
public class EmployeePayroll {
	...
	frmGeorgetownCleaningServices.getContentPane().setBackground(Color.GRAY);
	...
	panel.setBorder(
		new TitledBorder(null, "Employee Identification", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	panel_2.setBorder(
		new TitledBorder(null, "Payroll Processing", TitledBorder.LEADING, TitledBorder.TOP, null, null));
	...
	btnProcess.setBackground(Color.GRAY);
	btnProcess.addActionListener(new ActionListener() {
	    public void actionPerformed(ActionEvent event) {
		double[] week1Hours = { Double.valueOf(textField.getText()), Double.valueOf(textField_1.getText()),
			Double.valueOf(textField_2.getText()), Double.valueOf(textField_3.getText()),
			Double.valueOf(textField_4.getText()), Double.valueOf(textField_5.getText()),
			Double.valueOf(textField_6.getText()) };
		double[] week2Hours = { Double.valueOf(textField_13.getText()), Double.valueOf(textField_12.getText()),
			Double.valueOf(textField_11.getText()), Double.valueOf(textField_10.getText()),
			Double.valueOf(textField_9.getText()), Double.valueOf(textField_8.getText()),
			Double.valueOf(textField_7.getText()) };
